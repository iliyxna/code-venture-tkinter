...
class ProgressTrackerFrame(customtkinter.CTkFrame):
    def __init__(self, master, user):
        ...
        pt_label = customtkinter.CTkLabel(pt_frame, text="Progress Bar", font=("Cascadia Mono Bold",16))
        ...
        modules_label = customtkinter.CTkLabel(modules_frame, text="Modules Completed", font=("Cascadia Mono Bold",16))
